...
public class GrabbableCubeTest : MonoBehaviour
{
    ...
    public float pinchHoldDuration = 0.1f; // Duration to check if it is pinch or pinch and hold
    ...
    void Update()
    {
        bool isFingerPinching = rightHand.GetFingerIsPinching(OVRHand.HandFinger.Ring);
